    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
                new Product { Id = 1, CategoryId = 1, Name = "Grunge Skater Jeans", Sku = "AWMGSJ", Price = 68, IsAvailable = true,TrackingId="12345",TrackingStatus="Ordered",CustomerId=1 },
                ...
                new Product { Id = 6, CategoryId = 1, Name = "Unisex Thermal Vest", Sku = "AWMUTV", Price = 95, IsAvailable = true ,TrackingId="43345",TrackingStatus="Ordered",CustomerId=6},
                new Product { Id = 7, CategoryId = 1, Name = "V-Neck Pullover", Sku = "AWMVNP", Price = 65, IsAvailable = true ,TrackingId="8978",TrackingStatus="Ordered",CustomerId=7},
                new Product { Id = 8, CategoryId = 1, Name = "V-Neck Sweater", Sku = "AWMVNS", Price = 65, IsAvailable = true ,TrackingId="6766",TrackingStatus="Delivered",CustomerId=8},
                new Product { Id = 9, CategoryId = 1, Name = "V-Neck T-Shirt", Sku = "AWMVNT", Price = 17, IsAvailable = true ,TrackingId="444565",TrackingStatus="Ordered",CustomerId=9},
                new Product { Id = 10, CategoryId = 2, Name = "Bamboo Thermal Ski Coat", Sku = "AWWBTSC", Price = 99, IsAvailable = true ,TrackingId="45245",TrackingStatus="Ordered",CustomerId=10},
                new Product { Id = 11, CategoryId = 2, Name = "Cross-Back Training Tank", Sku = "AWWCTT", Price = 0, IsAvailable = false ,TrackingId="23445",TrackingStatus="Delivered",CustomerId=11},
                new Product { Id = 12, CategoryId = 2, Name = "Grunge Skater Jeans", Sku = "AWWGSJ", Price = 68, IsAvailable = true ,TrackingId="22678",TrackingStatus="Ordered",CustomerId=12},
                new Product { Id = 13, CategoryId = 2, Name = "Slicker Jacket", Sku = "AWWSJ", Price = 125, IsAvailable = true ,TrackingId="443567",TrackingStatus="Delivered",CustomerId=13},
                new Product { Id = 14, CategoryId = 2, Name = "Stretchy Dance Pants", Sku = "AWWSDP", Price = 55, IsAvailable = true ,TrackingId="32267",TrackingStatus="Delivered",CustomerId=14},
